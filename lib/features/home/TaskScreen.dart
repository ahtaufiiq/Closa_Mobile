      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            ShowBottomSheet.addTodo(context,
                                                type: "highlight");
                                          },
                                          child: Container(
                                            margin: EdgeInsets.only(
                                  ...
                                  GestureDetector(
                                    ...
                                    onLongPress: () {
                                      var todo = {
                                        ...
                                        "type": snapshot.data.docs.last['type'],
                                        "time": snapshot
            ...
            Positioned(
              child: GestureDetector(
                onTap: () => ShowBottomSheet.addTodo(context),
                child: Container(
