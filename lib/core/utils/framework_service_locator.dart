// import 'package:closa_flutter/core/network/network.dart';
import 'package:closa_flutter/core/storage/app_config.dart';
...
class FrameworkServiceLocator {
  ...
  Future setupFrameworkLocator(GetInterface getX) async {
